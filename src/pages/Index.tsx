...
import { Stethoscope, User, Shield, ArrowRight, Calendar, FileText, Clock, CheckCircle } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-12">
              ...
              <Link to="/admin" className="group">
                <div className="p-6 rounded-xl bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 hover:bg-primary-foreground/20 transition-all duration-300">
                  ...
                  <p className="text-sm text-primary-foreground/70 mb-4">Panel zarządzania systemem</p>
                  <div className="flex items-center justify-center gap-2 text-sm font-medium">
                    Panel admina
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </div>
